    ...
    <div className="min-h-screen flex bg-[#080810]">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col items-center justify-center p-16">
        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          <p className="text-red-400 font-bold tracking-[0.3em] text-sm uppercase mb-3">Adarsh Cheats</p>
          <p className="text-gray-500 text-base mb-12 leading-relaxed">
            Create your account and start protecting your applications today
          </p>

          <div className="grid grid-cols-2 gap-4">
            {[
              { label: 'Applications', value: 'Unlimited' },
              { label: 'License Keys', value: 'Unlimited' },
              { label: 'Users', value: 'Unlimited' },
              { label: 'Sessions', value: 'Real-time' },
            ].map((item) => (
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-11 bg-white/[0.04] border rounded-xl text-white placeholder-gray-600 text-sm focus:outline-none transition-all ${
